  ...
  return (
    <div className="design__info">
      ...
      <div className="design__box">
        ...
        <p className="design__info-text">"Матрица Судьбы" — инновационная онлайн-платформа, предлагающая уникальный подход к пониманию личной судьбы. Она позволяет пользователям расшифровать </p>
      </div>
    </div>
  );
};
