    ...
    <div className="design-person__unconscious">
      ...
      <div className="design-person__column">
        <div className="design-person__item">
          ...
          <p className="design-person__num-item">25.2</p>
        </div>
        <div className="design-person__item">
          <div className="design-person__icon">
            <Sprite icon="planets-earth" width={21} height={21} />
          </div>
          <p className="design-person__num-item">46.2</p>
        </div>
        <div className="design-person__item">
          <div className="design-person__icon">
            <Sprite icon="planets-northnode" width={18} height={21} />
          </div>
          <p className="design-person__num-item">31.1</p>
        </div>
        <div className="design-person__item">
          <div className="design-person__icon">
            <Sprite icon="planets-southnode" width={18} height={20} />
          </div>
          <p className="design-person__num-item">41.1</p>
        ...
        <div className="design-person__item">
          ...
          <p className="design-person__num-item">46.3</p>
          <Sprite icon="up-pink" width={8} height={9} />
        </div>
        <div className="design-person__item">
          <div className="design-person__icon">
          ...
          <p className="design-person__num-item">55.5</p>
        </div>
        <div className="design-person__item">
          <div className="design-person__icon">
            <Sprite icon="planets-venus" width={15} height={22} />
          </div>
          <p className="design-person__num-item">37.3</p>
        </div>
        <div className="design-person__item">
          <div className="design-person__icon">
            <Sprite icon="planets-mars" width={20} height={21} />
          </div>
          <p className="design-person__num-item">3.2</p>
        ...
        <div className="design-person__item">
          ...
          <p className="design-person__num-item">27.5</p>
          <Sprite icon="up-pink" width={8} height={9} />
        ...
        <div className="design-person__item">
          ...
          <p className="design-person__num-item">2.2</p>
          <Sprite icon="up-pink" width={8} height={9} />
        </div>
        ...
        <div className="design-person__item">
          ...
          <p className="design-person__num-item">49.1</p>
        </div>
        <div className="design-person__item">
          <div className="design-person__icon">
        ...
        <div className="design-person__item">
          ...
          <p className="design-person__num-item">5.2</p>
